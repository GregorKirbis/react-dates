...
var CalendarMonth = /*#__PURE__*/function (_ref2, _ref) {
  ...
  CalendarMonth.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    var month = nextProps.month,
      enableOutsideDays = nextProps.enableOutsideDays,
      firstDayOfWeek = nextProps.firstDayOfWeek;
    var prevMonth = prevState.month,
      prevEnableOutsideDays = prevState.enableOutsideDays,
      prevFirstDayOfWeek = prevState.firstDayOfWeek;
  ...
  _proto.render = function render() {
    var _this$props = this.props,
      dayAriaLabelFormat = _this$props.dayAriaLabelFormat,
      ...
      onYearSelect = _this$props.onYearSelect,
      orientation = _this$props.orientation,
      phrases = _this$props.phrases,
      renderCalendarDay = _this$props.renderCalendarDay,
      renderDayContents = _this$props.renderDayContents,
      renderMonthElement = _this$props.renderMonthElement,
      renderMonthText = _this$props.renderMonthText,
      css = _this$props.css,
      styles = _this$props.styles,
      verticalBorderSpacing = _this$props.verticalBorderSpacing;
